...
total_data = load_newsdata('/home/yi-hsien/ntnu/test_csv/central200V1.csv')
...
import numpy as np
import csv
with open('/home/yi-hsien/ntnu/test_csv_results/central200V1.csv', 'w', newline='') as myfile:
