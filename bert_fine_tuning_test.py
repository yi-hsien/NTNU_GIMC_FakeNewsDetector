...
total_data = load_newsdata('/home/yi-hsien/ntnu/test_csv/ettoday200V2.csv')
...
import numpy as np
import csv
with open('/home/yi-hsien/ntnu/test_csv_results/ettoday200V2.csv', 'w', newline='') as myfile:
