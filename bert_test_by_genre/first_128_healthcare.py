...
total_data = load_newsdata('/home/yi-hsien/ntnu/test_csv/healthcare/trainingset/trainingSet10kr0201.csv').sample(frac=1).reset_index(drop=True)
...
tf.saved_model.save(model,'/home/csliao/tf01/yi-hsien/healthcare_1')
